...
\subsection{Hardware Design}
	...
	Regarding the overall design, the hardware design allows for \textit{portability} and \textit{independence}, since the interface simply connected to the video output on the scanner and did not integrate with the scanner software, and \textit{compatibility}, since multiple machine vendors have some form of video output that can be used to capture the navigator image with a frame grabber.
